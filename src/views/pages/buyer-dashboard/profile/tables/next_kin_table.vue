...
import { userService } from "@/helpers/fakebackend/user.service.js";
...
export default {
  data() {
    return {
      ...
      filter: null,
      filterOn: [],
      sortBy: "next_Of_Kin.full_name",
      sortDesc: false,
      fields: [
        // { key: "id", sortable: true},
        { key: "next_Of_Kin.full_name", sortable: true, label: "Name" },
        { key: "next_Of_Kin.id_number", sortable: true, label: "Id Number" },
        { key: "next_Of_Kin.phone_number", sortable: true, label: "Phone Number" },
  ...
  methods: {
    getAfricanaData() {
      ...
      // const url = 'https://ug-africana-api.azurewebsites.net/'
      axios.get(userService.API_URL + "get_user?email=" + JSON.parse(localStorage.getItem("user")).email)
